...
<header class="pb-6 bg-white lg:pb-0">
    ...
    <div class="flex items-center justify-between hidden mb-6 lg:flex lg:items-center lg:ml-auto lg:space-x-10">
                <a href="#" title="" class="text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTo_pWoqYRsX_RV9mLOkbd_dm-6wATkcnu1g&s" alt="logo" width="150px"/> </a>
                ...
                <a href="/aboutus" title="" class="text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> <img src="https://presentations.gov.in/wp-content/uploads/2020/06/nic-logo-nic-logo-1-bilingual-sans-01.jpg" alt="logo" width="200px"/> </a>
